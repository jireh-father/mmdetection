...
train_transforms = [
    ...
    dict(type='RandomGamma', gamma_limit=[30, 150], p=0.05),
    dict(type='RGBShift', p=0.05),
    dict(type='CLAHE', clip_limit=[1, 35], p=0.05),
    ...
    dict(type='GaussNoise', var_limit=[10, 100], p=0.05),
    dict(type='ISONoise', color_shift=[0, 50], p=0.05),
